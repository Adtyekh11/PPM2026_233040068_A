        ...
        child: Column(
          ...
          children: [
            Center(
              child: Column(
                children: [
                  ...
                  const CircleAvatar(
                    radius: 50,
                    backgroundImage: NetworkImage('https://avatars.githubusercontent.com/u/146063491?s=400&u=b2236ea5f7c4a1dd030ce6bb53a1237f99a6002c&v=4'),
            ...
            const SectionCard(
              ...
              title: 'Tentang Saya',
              content: 'Saya sangat suka persib dan AI',
            ),
            const SectionCard(
              icon: Icons.school,
              title: 'Pendidikan',
            ...
            const SectionCard(
              icon: Icons.email,
              title: 'Kontak',
              content: 'adityaganteng@email.com\n088-888-888-888',
            ),
